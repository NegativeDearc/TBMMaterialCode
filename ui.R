...
shinyUI(fluidPage(
  ...
  tabsetPanel(id = 'tab',
              tabPanel('Dayshift',value = 'Dayshift',icon = icon('sun-o'),
                       ...
                       fluidPage(
                         ...
                         sidebarPanel(
                           ...
                           div(HTML('<marquee>Note:为了确保数据的准确性，请刷新页面</marquee>'),style = 'color:red')
                         ),
                         mainPanel(
                           tabsetPanel(id = 'day',
              ...
              tabPanel('NetworkD3',value = 'network',icon = icon('line-chart'),
                       fluidPage(
                         hr(),
                         sidebarPanel(
                           width = 2,
                         ...
                         mainPanel(tabsetPanel(
                           tabPanel('DayShift',simpleNetworkOutput('network'))
                         ))
                         ))
